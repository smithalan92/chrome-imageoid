...
Download the .crx file [here](extension/chrome-imageoid.crx). In chrome, open up [chrome://extensions](chrome://extensions), check the box to enabled Developer Mode and drag the crx file you downloaded onto the extensions page.
